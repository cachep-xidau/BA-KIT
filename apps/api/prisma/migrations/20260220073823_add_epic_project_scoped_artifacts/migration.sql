...
INSERT INTO "new_Artifact" ("archivedAt", "content", "createdAt", "functionId", "id", "sourceHash", "status", "type", "version") SELECT "archivedAt", "content", "createdAt", "functionId", "id", "sourceHash", "status", "type", "version" FROM "Artifact";
DROP TABLE "Artifact";

...
- **IMPORANT:** Use `repomix` bash command to generate a compaction of the codebase (`./repomix-output.xml`), then generate a summary of the codebase at `./docs/ck:codebase-summary.md` based on the compaction.
...
2. **IMPORTANT:** Run `repomix` bash command to generate/update a comprehensive codebase summary and create `./docs/ck:codebase-summary.md` based on the compaction file `./repomix-output.xml`
...
- Create or update `./docs/ck:code-standards.md` with a comprehensive codebase structure and code standards

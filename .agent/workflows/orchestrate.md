...
4. **Current Plan State:** If `~/.claude/ck:plans/` has a plan, include it
...
- Current Plan: ~/.claude/ck:plans/playful-roaming-dream.md exists with initial structure
...
### Mode
[Current Claude Code mode: plan/edit/ck:ask]
